...
def test_client_sessions_include_termux_attach_metadata():
    ...
    assert payload["termux_attach"] == {
        ...
        "ssh_username": "rajesh",
        "ssh_proxy_command": "cloudflared access ssh --hostname %h",
        "ssh_command": "ssh -o 'ProxyCommand=cloudflared access ssh --hostname %h' -t rajesh@ssh.sm.rajeshgo.li /opt/homebrew/bin/tmux attach-session -t codex-fork-fork1001",
