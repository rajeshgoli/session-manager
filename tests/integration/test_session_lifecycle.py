...
class TestSessionLifecycle:
    ...
    async def test_kill_session_flow(self, session_manager, mock_tmux, temp_state_file):
        ...
        assert session.completion_status == CompletionStatus.RETIRED
        assert session.completion_message == "Retired via sm retire"
        ...
        assert saved_state["sessions"][0]["completion_status"] == "retired"
